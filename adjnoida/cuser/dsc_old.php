...
<div class="w3-container">
  <h3 style="text-shadow:5px 5px 0 #111" class="w3-text-green w3-xxxlarge w3-center"><b>Central Goods & Service Tax Commissionerate, Noida</b></h3>
  <h3 class="w3-center w3-text-red w3-xxlarge">(Adjudication Branch)</h3>
  ...
  <div class="w3-card-4">
	...
	<div class="w3-small " style="margin:7px;">
		<button class="w3-button w3-blue w3-round w3-card-4" type="submit1" name="submit1" >Insert</button>
		<button class="w3-button w3-blue w3-round w3-card-4" type="submit2" name="submit2" >Delete</button>
		<button class="w3-button w3-blue w3-round w3-card-4" type="submit3" name="submit3" >Update</button>
		<button class="w3-button w3-blue w3-round w3-card-4" type="submit4" name="submit4" >Display</button>
		<button class="w3-button w3-blue w3-round w3-card-4" type="submit5" name="submit5" >Search</button>
	</div>
