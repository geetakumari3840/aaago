...
<div class="w3-container">
    ...
    <h3 style="margin:0px;padding:5px;" class="w3-center w3-text-red w3-large"><b>(DSCN pending for issuance for Commissioner Competency
)</b></h3>
  <div class="w3-bar w3-black w3-card-2">

    <button class="w3-bar-item w3-green" style="width:16.666%;" >D. S. C. N. </button>
    <button class="w3-bar-item w3-button tablink w3-hover-text-purple w3-hover-black w3-hover-shadow" 
            style="width:16.666%" type="display1" name="display1" onclick="openCity(event,'Display')">Display All</button>
    <button class="w3-bar-item w3-button tablink w3-hover-text-purple w3-hover-black w3-hover-shadow" 
            style="width:16.666%" onclick="openCity(event,'Search')">Search</button>
    <button class="w3-bar-item w3-button tablink w3-hover-text-purple w3-hover-black w3-hover-shadow" 
            style="width:16.666%" onclick="openCity(event,'Insertr')">Insert Records</button>
    <button class="w3-bar-item w3-button tablink w3-hover-text-purple w3-hover-black w3-hover-shadow" 
            style="width:16.666%" onclick="openCity(event,'Editr')">Edit Records</button>
    <button class="w3-bar-item w3-button tablink w3-hover-text-purple w3-hover-black w3-hover-shadow" 
    style="width:16.666%" onclick="openCity(event,'Deleter')">Delete Records</button>

  </div>

  <div id="Display" class="w3-container w3-border city" style="display:none">
<!-- display -->
   <?php
