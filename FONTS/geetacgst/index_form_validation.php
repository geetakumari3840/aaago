    ...
    <table align="center" class="table table-bordered" style="width: 100%;">
      <tr align="center" class="bg-warning">
        ...
        <td >
          ...
          placeholder="File Date" name="NodalDate"  style="text-align: center;" required>
        </td>
        <td>
          <label>CGST Receiving Date</label>
          <input type="date" class="form-control" id="CGSTRDate" 
          placeholder="Forwarding Date" name="CGSTRDate" style="text-align: center;" required>
        </td>

        <td  style="width: 47%">
          <label>Name of Assessee</label>
          <input type="text"  list="browers" id="live" name="NameOfParty"
          placeholder="Name of Party" class="form-control live"  style="text-align: left;" required>
          <datalist id="browers"><div id="result"></div></datalist>
        </td>
        <td style="width: 7%;">
          <label>Khand</label>
          <input type="number"  class="form-control" id="Khand" 
    ...
    rowspan="2">Action</th>
      ...
      <tr class="bg-info">
        <td><input class="form-control RFDMonth" placeholder="MM" 
          type="number"  maxlength="2"  min=1 max=12 required></td>
        <td><input type="number"  class="form-control RFDYear"  
           placeholder="YY" maxlength="2" name="RFDYear"  min=17 max=18 required></td>
        <td><input type="number"  class="form-control RFD2Month"  
                   placeholder="MM" maxlength="2" name="RFD2Month" min=1 max=12 required></td>
        <td><input type="number"  class="form-control RFD2Year"  
          placeholder="YY" maxlength="2" name="RFD2Year" min=17 max=18 required></td>
        <td><input type="text"  class="form-control SanctionOrderNo"  
          placeholder="1234" maxlength="4" name="SanctionOrderNo"></td>
        <td><input type="number"  class="form-control SanctonOrderDay"  
                   placeholder="DD" maxlength="2" name="SanctonOrderDay" min=1 max=31 required></td>
        <td><input type="number"  class="form-control SanctonOrderMonth"  
                  placeholder="MM" maxlength="2" name="SanctonOrderMonth"  min=1 max=12 required></td>
        <td><input type="number"  class="form-control SanctonOrderYear"  
            placeholder="YY" maxlength="2" name="SanctonOrderYear"  min=17 max=18 required></td>
        <td><input type="text"  class="form-control CGST"  
                   placeholder="In Rs." maxlength="8" name="CGST" required></td>
        <td><input type="number"  class="form-control IGST"  
                   placeholder="In Rs." maxlength="8" name="IGST" required></td>
        <td><input type="number"  class="form-control Cess"  
                   placeholder="In Rs." maxlength="8" name="Cess" required></td>
        <td><select type="number"  class="form-control RFD"  
                   placeholder="4/6" maxlength="1" name="RFD" min=4 max=6 required>
<option value="4" selected>4</option><option value="6">6</option></select></td>
        <td align="right">
      ...
      <table style="width:100%;">
        ...
        <td ><button id="save" type="submit" class="btn btn-info btn-sm">Save</button></td>
...
//Add Multi column
 ...
 var html_code = "<tr class='bg-danger'  id='row"+count+"'>";
    html_code += "<td><input type='number' class='form-control RFDMonth' placeholder='MM' maxlength='2' name='RFDMonth' min=1 max=12 required></td>";
    html_code += "<td><input type='text'  class='form-control RFDYear' placeholder='YY' maxlength='2' name='RFDYear'></td>";
    html_code += "<td><input type='number'  class='form-control RFD2Month' placeholder='MM' maxlength='2' name='RFD2Month' min=1 max=12 required></td>";
    ...
    html_code += "<td><input type='number'  class='form-control SanctonOrderMonth'  placeholder='MM' maxlength='2' name='SanctonOrderMonth' min=1 max=12 required></td>";
    ...
    html_code += "<td><select type='text'  class='form-control RFD' placeholder='4/6' maxlength='1' name='RFD'><option value='' selected></option><option value='4' selected>4</option><option value='6'>6</option></select></td>";
